...
초기 등록시 유저에게 구글 어센티케이터 등록 방법에 대해 안내하는 메시지를 표시하여, 구글 어센티케이터 등록 방법을 쉽게 알 수 있도록 절차를 제시한다. 초기 등록시 주변에 다른 사람이 있어서 QR 코드가 유출 가능성도 있기 때문에 이에 대한 주의사항과 함께, 리프레시 버튼을 두어 시크릿 키를 재발급할 수 있도록 하여, 초기 등록시 유출을 방지할 수 있도록 하자.
