...
- 자바스크립트는 비구조화 할당 패턴을 통해서 특수한 형태의 오브젝트 구조에 의존하는 사양의 기능을 만들 수 있다.
