...
타입스크립트와 같이 런타임에 타입을 검증하기 어려운 언어의 경우, 정의된 타입 중 어느 부분의 문제로 타입이 잘못되었는지 파악하기 어려울 수 있다. 그에 반해, php는 값을 디버깅하면 타입의 변화를 추적할 수 있기 때문에 적절한 타입이 전달되었는지 추적 및 디버깅이 수월하다는 장점도 있다.
