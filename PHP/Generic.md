...
php만으로 비즈니스 로직을 구성하고, 서비스를 제공하는데 문제는 없다. 하지만, 최근 많은 언어들이 좋은 타입 시스템을 도입하고 있기 때문에 다른 언어를 병행하는 경험을 제공하는 것이 좋다고 본다. 최소한 타입스크립트 정도는 병용하여 기본적으로 알아야 할 타입에 대한 지식을 습득시키는 것이 좋지 않을까?
