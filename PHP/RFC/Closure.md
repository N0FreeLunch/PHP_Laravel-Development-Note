...
- 객체에서 사용된 클로저란 객체의 멤버 함수의 리턴값이 되는 클로저 또는 클로저의 리턴값 리턴된 클로저의 리턴된 클로저 .... 계속해서 $this를 사용할 수 있다.
- 하지만 멤버의 리턴값이 아닌 함수의 인자로 사용되는 클로저의 경우 $this를 가지고 있지 않거나 $this를 가지고 있다고 해도 클로저가 선언된 객체의 $this가 아닌, 인자로 클로저를 사용하는 함수의 객체의 $this를 가지게 된다.
