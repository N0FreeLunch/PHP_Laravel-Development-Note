...
또는 Value Object를 정의해서 클로저 대신 사용하는 방법도 좋은 방법이다. Value Object는 도메인의 제약이 담긴 값을 담는 용도 뿐만 아니라, 도메인의 제약사항을 표현하는 로직을 담은 클래스를 만드는 방식으로 활용한다.
