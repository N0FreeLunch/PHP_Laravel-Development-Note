...
- 함수의 인자가 많아질 경우를 대비해 기능을 함수단위로 만들기 보다 객체 단위로 만들자. php의 경우 함수형 프로그래밍 처럼 함수에 커링 기능을 이용하여 기능을 실행하기 위해 필요한 요구사항을 정의하는 것이 불편하기 때문에 객체를 사용하여 요구사항을 메소드로 정의하고 정의된 메소드를 사용할 수 있게 만들자.
